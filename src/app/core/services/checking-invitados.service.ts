	...
	private eventosSubject = new BehaviorSubject<Evento[]>([
		{
			...
			folio: 'NV-00001',
			totalGuests: 150,
			cliente: 'Ana García y Carlos Martínez',
			tipoEvento: 'Boda',
			lugar: 'Jardín Las Magnolias',
			montoTotal: 250000,
			fechaEvento: '15 Enero 2025',
		},
		{
			id: 2,
			name: 'XV Años María',
		...
		},
		{
			...
			folio: 'NV-00003',
			totalGuests: 50,
			cliente: 'Roberto y Carmen Rodríguez',
			tipoEvento: 'Bautizo',
			lugar: 'Casa de Campo El Encanto',
			montoTotal: 45000,
			fechaEvento: '25 Enero 2025',
		},
		{
			id: 4,
			...
			lugar: 'Hotel Ejecutivo Centro',
			montoTotal: 180000,
			fechaEvento: '01 Febrero 2025',
		},
		{
			id: 5,
			name: 'Graduación Ingenierías',
			date: '2025-02-10',
			folio: 'NV-00005',
			totalGuests: 200,
			cliente: 'Universidad Tecnológica',
			tipoEvento: 'Graduación',
			lugar: 'Auditorio Principal Campus',
			montoTotal: 320000,
			fechaEvento: '10 Febrero 2025',
		},
		{
			id: 6,
			name: 'Primera Comunión Sofía',
			date: '2025-02-15',
			folio: 'NV-00006',
			totalGuests: 60,
			cliente: 'Familia Mendoza',
			tipoEvento: 'Primera Comunión',
			lugar: 'Quinta Los Rosales',
			montoTotal: 75000,
			fechaEvento: '15 Febrero 2025',
		},
		{
			id: 7,
			...
			folio: 'NV-00007',
			totalGuests: 100,
			cliente: 'Laura Torres y Miguel Ángel',
			tipoEvento: 'Boda',
			lugar: 'Resort Playa Paraíso',
			montoTotal: 450000,
			fechaEvento: '05 Marzo 2025',
		},
		{
			id: 8,
			...
			folio: 'NV-00008',
			totalGuests: 75,
			cliente: 'José y María Elena López',
			tipoEvento: 'Aniversario',
			lugar: 'Restaurante La Tradición',
			montoTotal: 95000,
			fechaEvento: '20 Marzo 2025',
		},
	]);
